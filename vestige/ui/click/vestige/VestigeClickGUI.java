...
public class VestigeClickGUI extends dG {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		//Gui.drawRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), 0x20000000);
		//this.drawGradientRect(0, 0, sr.getScaledWidth(), (int) (sr.getScaledHeight() * 1.4), 0x0, ColorUtil.vestigeColors(4, 0));
	...
	private void drawCategory(Category c, int startX, int startY, int endX, int endY) {
		...
		for(int i = startX; i < endX; i++) {
			Gui.drawRect(i, startY, i + 1, endY, ColorUtil.vestigeColors2(4, -i * 3));
		}
